...
public class DurationEx {
    ...
    public static void main(String[] args) {
        ...
        Duration duration1 = Duration.ofHours(48); // Represents a duration of 2 hours.
        ...
        Duration doubledDuration = duration1.multipliedBy(2); // Multiplies duration2 by 2.
        ...
        System.out.println(totalDuration.abs());
    }
}